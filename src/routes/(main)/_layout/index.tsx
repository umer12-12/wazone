...
import SultanNavbar from '@/features/SultanNavbar';
...
const TrialUrgencyBanner = dynamic(() => import('@/features/TrialUrgencyBanner'));
  ...
  return (
    <HotkeysProvider initiallyActiveScopes={[HotkeyScopeEnum.Global]}>
      ...
      <DndContextWrapper>
        ...
        >
          <SultanNavbar />
          <Flexbox horizontal flex={1} width={'100%'} style={{ position: 'relative' }}>
            {/* <NavPanel /> Hiding legacy sidebar for Sultan Navbar */}
